...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        */
        ...
        $filiere1->setCategory('BAC Professionnel');
        ...
        $filiere2->setCategory('BAC Professionnel');
        ...
        $filiere3->setCategory('BAC Professionnel');
        ...
        $filiere4->setCategory('BAC Professionnel');
        ...
        $filiere5->setCategory('BAC Professionnel');
        ...
        $filiere6->setCategory('BAC Professionnel');
        ...
        $filiere7->setCategory('BAC Professionnel');
        ...
        $filiere8->setCategory('BAC Professionnel');
        ...
        $filiere9->setCategory('BAC Professionnel');
